...
const Header = () => {
    ...
    return (
        <header>
            <div className='header is-flex is-justify-content-space-between is-align-items-center px-6 full-width'>
                ...
                <div className='header-menu is-flex is-align-items-center'>
                    {
                        menulist.map((s, id) => (
                            <a href="#" key={id} className='is-uppercase has-text-weight-semibold is-flex is-justify-content-center is-align-items-center'><span>{s}</span> <CaretDown /></a>
                        ))
                    }
                </div>

                <div className='header-tool is-flex is-align-items-center is-size-4'>
                    <a href="#"><MagnifyingGlass /></a>
                    <a href="/login"><SignIn /></a>
                    <a href="#" className='is-relative'><Bag /> <div className='cart-amount'><span>0</span></div></a>
                </div>
            </div>
        </header>
    )
